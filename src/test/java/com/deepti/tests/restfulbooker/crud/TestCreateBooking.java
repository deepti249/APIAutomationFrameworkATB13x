package com.deepti.tests.restfulbooker.crud;

import com.deepti.base.BaseTest;
...
public class TestCreateBooking extends BaseTest{
    ...
    @Test(groups = "reg", priority = 1)
    @Owner("Deepti Lodha")
    @Description("TC#5 - Verify that the Booking cannot be Created, when Payload is wrong")
    ...
    @Test(groups = "reg", priority = 1)
    @Owner("Deepti Lodha")
    @Description("TC#6 - Verify that the Booking cannot be Created, when Base URL is wrong")
